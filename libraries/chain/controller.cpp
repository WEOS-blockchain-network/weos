...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( weos, weos, newaccount );
   SET_APP_HANDLER( weos, weos, setcode );
   SET_APP_HANDLER( weos, weos, setabi );
   SET_APP_HANDLER( weos, weos, updateauth );
   SET_APP_HANDLER( weos, weos, deleteauth );
   SET_APP_HANDLER( weos, weos, linkauth );
   SET_APP_HANDLER( weos, weos, unlinkauth );
/*
   SET_APP_HANDLER( weos, weos, postrecovery );
   SET_APP_HANDLER( weos, weos, passrecovery );
   SET_APP_HANDLER( weos, weos, vetorecovery );
*/

   SET_APP_HANDLER( weos, weos, canceldelay );
   }

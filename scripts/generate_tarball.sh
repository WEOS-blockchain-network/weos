...
mkdir -p ${EOS_PREFIX}/licenses/weos
...
# install licenses
cp -R ${BUILD_DIR}/licenses/weos/* ${EOS_PREFIX}/licenses || exit 1

# install libraries
#cp -R ${BUILD_DIR}/lib/* ${EOS_PREFIX}/lib

# install cmake modules
#sed "s/_PREFIX_/\/${SPREFIX}/g" ${BUILD_DIR}/modules/WeosTesterPackage.cmake &> ${EOS_PREFIX}/lib/cmake/${PROJECT}/WeosTester.cmake
...
#ln -sf ../../../${SUBPREFIX}/lib/cmake/${PROJECT}/WeosTester.cmake WeosTester.cmake
#popd &> /dev/null

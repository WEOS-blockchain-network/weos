...
const static name system_account_name    { N(weos) };
const static name null_account_name      { N(weos.null) };
const static name producers_account_name { N(weos.prods) };
...
const static name eosio_auth_scope       { N(weos.auth) };
const static name eosio_all_scope        { N(weos.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name eosio_any_name  { N(weos.any) };
const static name eosio_code_name { N(weos.code) };

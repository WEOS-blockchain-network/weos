...
try:
    ...
    retMap = node0.publishContract("weos", contractDir, wasmFile, abiFile, True, shouldFail=True)
    ...
    time.sleep(0.6)
    retMap = node0.publishContract("weos", contractDir, wasmFile, abiFile, True)

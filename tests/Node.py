...
class Node(object):
    ...
    def getAccountEosBalanceStr(self, scope):
        ...
        assert isinstance(scope, str)
        amount=self.getTableAccountBalance("weos.token", scope)
    ...
    # Require PREACTIVATE_FEATURE to be activated and require weos.bios with preactivate_feature
    def preactivateProtocolFeatures(self, featureDigests:list):
        for digest in featureDigests:
            ...
            trans=self.pushMessage("weos", "activate", data, opts)
